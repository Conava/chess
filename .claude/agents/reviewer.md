---
name: reviewer
description: Full branch compliance review. Strictly read-only. Run once after 
  executor, test-writer, and docs-keeper are all done. Saves output as a .md 
  file. Never fixes anything — flags only.
