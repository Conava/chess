...
public class MainFrame extends JFrame {
    ...
    public void switchToOfflineGame() {
        ...
        if(dialog.isConfirmed())
        {
            ...
            chessGame = new ChessGame(this, chess, colorScheme, false, selectedRuleset, playerWhiteName, playerBlackName, null);
    ...
    public void switchToOnlineGame() {
        ...
        if (dialog.isConfirmed()) {
            ...
            this.setMinimumSize(new Dimension(GAME_WINDOW_WIDTH, GAME_WINDOW_HEIGHT));
            chessGame = new ChessGame(this, chess, colorScheme, true, selectedRuleset, playerWhiteName, playerBlackName, onlineGameOptions);
            setExtendedState(JFrame.MAXIMIZED_BOTH);
            setContentPane(chessGame);
            validate();
            LOGGER.log(Level.INFO, "Loaded game window successfully");
